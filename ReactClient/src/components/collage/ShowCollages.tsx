        ...
        <div >
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "20px", justifyContent: "center", maxWidth: "1100px", margin: "0 auto" }}>
                {collages.map((collage, index) => (
                    <div key={collage.id} style={{ position: "relative", }} onMouseEnter={() => setHoveredCollage(collage.id)} onMouseLeave={() => setHoveredCollage(null)}                    >

                        <Card style={{ width: "100%", height: "100%", position: "relative" }}>
                            <CardMedia component="img" height="100%" image={imageUrls[collage.id]} alt={collage.name} style={{ objectFit: "contain", cursor: "pointer", opacity: hoveredCollage === collage.id ? 0.5 : 1, transition: "opacity 0.3s ease-in-out", }} onClick={() => openImage(index)} />
...
//     return (
//         <div>
//             <h2 style={{ background: "linear-gradient(270deg, #00A0A8, #7D2AE8)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", display: "inline-block" }}>הקולאז'ים שלי</h2>
//             <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", justifyContent: "center", maxWidth: "1100px", margin: "0 auto" }}>
//                 {collages.map((collage, index) => (
//                     <Card key={collage.id} style={{ width: "auto", maxWidth: "200px", cursor: "pointer" }} onClick={() => openImage(index)}>
//                         <CardMedia
//                             component="img"
//                             image={imageUrls[collage.id]}
//                             alt={collage.name}
...
//             {selectedIndex !== null && (
//                 <Dialog open={true} onClose={closeImage} maxWidth="xl" fullScreen>
//                     <DialogActions style={{ position: "absolute", top: 0, right: 0 }}>
//                         <IconButton onClick={closeImage} style={{ color: "white" }}>
//                             <CloseIcon />
//                         </IconButton>
//                     </DialogActions>
//                     <img
//                         src={imageUrls[collages[selectedIndex].id]}
//                         alt="Selected"
